...
$Directories = 'LIBNAME.Extensions.Portable','LIBNAME.Extensions.Portable.Tests','LIBNAME.Extensions.Portable.NuGet'
$TemplateDirectories = @()
$SrcDirectories = @()
...
Write-Output "    $Src\$LibraryName.Extensions.Portable\$LibraryName.Extensions.Portable.csproj"
Write-Output "    $Src\$LibraryName.Extensions.Portable.Tests\$LibraryName.Extensions.Portable.Tests.csproj"
Write-Output "    $Src\$LibraryName.Extensions.Portable.NuGet\$LibraryName.Extensions.Portable.NuGet.nuproj"
Write-Output "2. Add your library to the README.md file."
Write-Output "3. Add a project references to $Src\$LibraryName.Portable.NuGet\$LibraryName.Portable.NuGet.nuproj"
