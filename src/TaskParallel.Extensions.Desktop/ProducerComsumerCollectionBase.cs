...
namespace System.Collections.Concurrent
{
    ...
    [Serializable]
    public abstract class ProducerConsumerCollection<T> : IProducerConsumerCollection<T>
    {
        ...
        protected ProducerConsumerCollection(IProducerConsumerCollection<T> contained)
        {
            if (contained == null)
